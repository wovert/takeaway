<template>
  <div class="shop-header">
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.pics[0]})`}">
        ...
        <div class="activity-sheet-content">
          ...
          <ul class="list">
            ...
            <span class="content-tag">
              ...
              <span class="activity-content">{{support.description}}</span>
            </li>
          </ul>
...
export default {
  data () {
    return {
      supportClasses: ['activity-green', 'activity-red', 'activity-orange', 'activity-pink', 'activity-silver'],
      shopShow: false,
      supportShow: false
    }
  },
