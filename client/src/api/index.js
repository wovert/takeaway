...
export const address = (geohash) => get(`/position/${geohash}`)

// [2、获取食品分类列表](#2获取食品分类列表)
export const foodTypes = () => get('/index_cateogry')

// [3、根据经纬度获取商铺列表](#3根据经纬度获取商铺列表)
export const shops = ({longitude, latitude}) => get('/shops', {longitude, latitude})
